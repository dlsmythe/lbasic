...
530  GOTO 510
535  PRINT "HOW MUCH DO YOU WANT TO SPEND ON MISCELLANEOUS SUPPLIES";
540  INPUT M1
...
1399  REM X SELECTS: 1)STOP AT FORT  2)HUNT  3)CONTINUE
...
1755  PRINT "RI";CHR$(7);"GHT BETWEE";CHR$(7);"N THE EYE";CHR$(7);"S---YOU GOT A";CHR$(7);" BIG ONE!!";CHR$(7);"!!"
1765  F=F+52+RND(0)*6
1770  B=B-10-RND(0)*4
1775  GOTO 1800
...
1899  REM ***EATING***
1900  PRINT "DO YOU WANT TO EAT (1) POORLY  (2) MODERATELY  OR (3) WELL";
1905  INPUT E
...
1999  REM MOVE -- E.G. RACK UP SOME MILEAGE
2000  LET M=M+200+(A-220)/5+10*RND(0)
2005  L1=C1=0 : REM NO BLIZZARD, ADEQUATE CLOTHING
...
2425  GOTO 3600 : REM GENERIC DEATH
...
2850  GOTO 3600 : REM GENERIC DEATH
2855  GOTO 3100
...
2892  K8=1
2893  GOTO 3555 : REM DEATH WITH CAUSE
...
2965  GOTO 4700 : REM ILLNESS
2970  PRINT "HAIL STORM---SUPPLIES DAMAGED"
2975  M=M-5-RND(0)*10
2977  B=B-200
2980  M1=M1-4-RND(0)*3
2985  GOTO 3100
2990  IF E=1 THEN 4700 : REM ILLNESS
2995  IF E=3 THEN 3010
3000  IF RND(0)>.25 THEN 4700 : REM ILLNESS
3005  GOTO 3100
3010  IF RND(0)<.5 THEN 4700 : REM ILLNESS
3015  GOTO 3100
...
3325  IF C<18+2*RND(0) THEN 4700 : REM ILLNESS
3330  GOTO 3215
3499  REM ***DYING***
3500  PRINT "YOU RAN OUT OF FOOD AND STARVED TO DEATH"
3505  GOTO 3600 : REM GENERIC DEATH


3520  LET T=0
3525  PRINT "YOU CAN'T AFFORD A DOCTOR"
3530  GOTO 3555 : REM DEATH WITH CAUSE
...
3600  PRINT
3602  PRINT "DUE TO YOUR UNFORTUNATE SITUATION, THERE ARE A FEW"
...
4015  PRINT "YOU";CHR$(7);" FINALLY ARRI";CHR$(7);"VED AT ORE";CHR$(7);"GON CITY";CHR$(7);
4020  PRINT "AFTER";CHR$(7);" 2040 LONG MILES";CHR$(7);"---HOORAY!!";CHR$(7);"!!!"
4025  PRINT
...
4765  M=M-5
4770  M1=M1-5
4780  IF M1<0 THEN 3550 : REM IF REMAINING MEDICAL SUPPLIES < 0 THEN...
4785  IF L1=1 THEN 3215 : REM IF BLIZZARD THEN 3215
4790  GOTO 3100
